...
\chapter{Introdução}\label{chap:introducao} % Inglês: Introduction
	...
	\sout{O sistema de interesse a ser estudado é o serviço interno prestado a esses clientes 
